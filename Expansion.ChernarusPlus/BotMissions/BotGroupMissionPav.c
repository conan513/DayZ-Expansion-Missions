class BotGroupMissionPav: CustomMission
{
	
	void BotGroupMissionPav() {}
	
	
	// Конфиги ботов
	vector BotSpawnPoint = "2126.428467 91.449623 3342.416016";				// задаем точку спавна бота	
	...
	protected float Zone_Radius = 300;											// Радиус триггера на игрока для появления ботов
